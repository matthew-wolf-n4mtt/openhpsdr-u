...
static int hf_hpsdr_u_com = -1;
static int hf_hpsdr_u_com_iq = -1;
static int hf_hpsdr_u_com_wb = -1;
//static int hf_hpsdr_u_com_gf = -1; //Field for displaying global flags, not needed for normal use.
...
proto_register_hpsdr_u(void)
{
   ...
   static hf_register_info hf[] = {
       ...
       { &hf_hpsdr_u_com,
           { "Start / Stop Command" , "hpsdr-u.start_stop",
            FT_UINT8, BASE_HEX,
            NULL, TH_MASK,
            "Commnds (2 bits)", HFILL }
       },
       { &hf_hpsdr_u_com_iq,
           { "IQ" , "hpsdr-u.com.start_stop.iq",
            FT_BOOLEAN, BOOLEAN_MASK,
            TFS(&start_stop), TH_IQ,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_com_wb,
           { "Wide Bandscope" , "hpsdr-u.com.start_stop.wb",
            FT_BOOLEAN, BOOLEAN_MASK,
            TFS(&start_stop), TH_WIDE_BANDSCOPE,
            NULL, HFILL }
       },
//Field for displaying global flags, not needed for normal use.
/*
       { &hf_hpsdr_u_com_gf,
           { "Global Flags" , "hpsdr-u.start_stop.gf",
            FT_UINT8, BASE_HEX,
            NULL, ALL_BITS_MASK,
            NULL, HFILL }
       },
*/
       ...
       { &hf_hpsdr_u_ep_f1,
           { "USB EP Frame 1 Submenu" , "hpsdr-u.ep6.f1_sub",
            FT_UINT8, BASE_HEX,
            NULL, ZERO_MASK,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_ep_f2,
           { "USB EP Frame 2 Submenu" , "hpsdr-u.ep6.f2_sub",
            FT_UINT8, BASE_HEX,
            NULL, ZERO_MASK,
            NULL, HFILL }
       },
       ...
       { &hf_hpsdr_u_c0_sub_1,
           { "C0 SubMenu" , "hpsdr-u.cc0.type_1",
            FT_UINT8, BASE_HEX,
            NULL, ALL_BITS_MASK,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_c0_sub_2,
           { "C0 SubMenu" , "hpsdr-u.cc0.type_2",
            FT_UINT8, BASE_HEX,
            NULL, ALL_BITS_MASK,
            NULL, HFILL }
       },
       ...
       { &hf_hpsdr_u_cc_fwdpw_ant_pre,
           { "SDR TX Forward Power From Anntena Preselector (AIN1)" , "hpsdr-u.cc.fwdpw.ant_pre",
            FT_UINT16, BASE_HEX,
            NULL, BIT12_MASK,
            NULL, HFILL }
       },
       ...
       { &hf_hpsdr_u_cc_revpwd_rev,
           { "SDR Reverse Power From Anntena Preselector (AIN2)" , "hpsdr-u.cc.revpwd.ant_pre_rev",
            FT_UINT16, BASE_HEX,
            NULL, BIT12_MASK,
            NULL, HFILL }
       },
       ...
       { &hf_hpsdr_u_cc_info_adc_overflow,
           { "ADC Overflow" , "hpsdr-u.cc.info.adc_overflow",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_info_cyclops_pll,
           { "Cyclops PLL" , "hpsdr-u.cc.info.cyclops_pll",
            FT_BOOLEAN, BOOLEAN_MASK,
            TFS(&lock_unlock), SDR_C1_PLL,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_info_freq_chg,
           { "SDR Frequency changed" , "hpsdr-u.cc.info.freq_chg",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_ep6_num_of_rx_1,
           { "Number of RX" , "hpsdr-u.ep6.num_rx_1",
            FT_UINT8, BASE_DEC,
            NULL, ALL_BITS_MASK,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_ep6_num_of_rx_2,
           { "Number of RX" , "hpsdr-u.ep6.num_rx_2",
            FT_UINT8, BASE_DEC,
            NULL, ALL_BITS_MASK,
            NULL, HFILL }
       },
       ...
       { &hf_hpsdr_u_cc_ant_pre_attn,
           { "Anntena Preselector Attenuator" , "hpsdr-u.cc.ant_pre-attn",
            FT_UINT8, BASE_HEX,
            VALS(ep2_pre_attn), HOST_C3_P_ATT,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_ant_pre_pre_amp,
           { "Anntena Preselector Preamp    " , "hpsdr-u.cc.ant_pre-pre_amp",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_ant_pre_ant,
           { "Anntena Preselector RX Anntena Selection" , "hpsdr-u.cc.ant_pre-ant",
            FT_UINT8, BASE_HEX,
            VALS(ep2_pre_rx_ant), HOST_C3_P_ANT,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_ant_pre_rx_out,
           { "Anntena Preselector RX Out" , "hpsdr-u.cc.ant_pre-rx_out",
            FT_BOOLEAN, BOOLEAN_MASK,
            TFS(&local_on_off), HOST_C3_P_OUT,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_ant_pre_tx_relay,
           { "Anntena Preselector TX Relay Selection" , "hpsdr-u.cc.ant_pre-tx_relay",
            FT_UINT8, BASE_HEX,
       ...
       { &hf_hpsdr_u_cc_rx_num,
           { "Number of Receivers" , "hpsdr-u.cc.rx_num",
            FT_UINT8, BASE_HEX,
            NULL, HOST_C4_RX_NU,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_mic_ts,
           { "Mic Time Stamping  " , "hpsdr-u.cc.mic_ts",
            FT_BOOLEAN, BOOLEAN_MASK,
            TFS(&local_on_off), HOST_C4_T_ST,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_com_merc_freq,
           { "Common Mercury Freq" , "hpsdr-u.cc.com_merc_freq",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_apollo_tunner,
           { "Hermes - Apollo Tuner " , "hpsdr-u.cc.apollo_tunner",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_filter_man,
           { "Alex Manual Filter Select" , "hpsdr-u.cc.ant_pre-man",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_dis_ant_pre_tr,
           { "Alex Disable T/R Relay" , "hpsdr-u.cc.dis-ant_pre",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_orion_mic_bias,
           { "Orion Mic Bias" , "hpsdr-u.cc.orion-mic_bias",
            FT_BOOLEAN, BOOLEAN_MASK,
            TFS(&local_enabled_disabled), HOST_C1_O_B,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_orion_mic_ptt,
           { "Orion Mic PTT " , "hpsdr-u.cc.orion-mic_ptt",
            FT_BOOLEAN, BOOLEAN_MASK,
            TFS(&local_disabled_enabled), HOST_C1_O_PT,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_codec_line_gain,
           { "Codec (TLV320) Line Gain" , "hpsdr-u.cc.codec-line_gain",
            FT_UINT8, BASE_DEC,
            NULL, HOST_C2_TLV,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_merc_tx_atten_c2,
           { "If Set, Mercury 20dB on TX" , "hpsdr-u.cc.merc-tx-atten_c2",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_merc_tx_atten_c3,
           { "Mercury 20 dB on TX" , "hpsdr-u.cc.merc-tx-atten_c3",
            FT_BOOLEAN, BOOLEAN_MASK,
       ...
       { &hf_hpsdr_u_cc_adc_input_atten_tx,
           { "C&C Byte 3- ADC Input TX Atten" , "hpsdr-u.cc.adc-input-atten_tx",
            FT_UINT8, BASE_DEC,
            NULL, HOST_C3_A_I_A,
            NULL, HFILL }
       },
       ...
       { &hf_hpsdr_u_cc_cw_ptt_delay,
           { "CW PTT Delay" , "hpsdr-u.cc.cw-ptt_delay",
            FT_UINT8, BASE_DEC,
            NULL, ALL_BITS_MASK,
            NULL, HFILL }
       },
       { &hf_hpsdr_u_cc_cw_hang_time,
           { "CW  Hang  Time  " , "hpsdr-u.cc.cw-hang_time",
            FT_UINT16, BASE_DEC,
            NULL, HOST_2_20_CW_H,
            NULL, HFILL }
       },
...
static int hpsdr_usb_ep2_frame(proto_tree *tree, tvbuff_t *tvb, packet_info *pinfo, int offset, int frame_num) {
   ...
   while ( tvb_get_guint24(tvb, offset,3) != 0x7F7F7F ) {  
       offset +=1;
       sync_error +=1; 
   }
...
static int hpsdr_usb_ep6_frame(proto_tree *tree, tvbuff_t *tvb, int offset, int frame_num) {
   ...
   if ( C0_masked == 0x0 ) {  // SDR Info 0
       ...
       offset += 1;
       proto_tree_add_item(hpsdr_u_tree_cc_info, hf_hpsdr_u_cc_info_mercury, tvb,offset, 1, ENC_BIG_ENDIAN);
       offset += 1;
       proto_tree_add_item(hpsdr_u_tree_cc_info, hf_hpsdr_u_cc_info_penelope, tvb,offset, 1, ENC_BIG_ENDIAN);
       offset += 1;
       append_text_item = proto_tree_add_item(hpsdr_u_tree_cc_info, hf_hpsdr_u_cc_info_interface, tvb,offset, 1,
                              ENC_BIG_ENDIAN);
       proto_item_append_text(append_text_item, "  :Ozy/Magister, Metis, Hermes, etc."); 
       offset += 1;
...
static void dissect_hpsdr_u(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree)
{
   ...
   if (tree) { 
       ...
       static guint64 discovery_phy_dst_addr; 
       static guint32 discovery_dst_addr;
       ...
       discovery_ether_address = tvb_get_ptr(tvb, 4, 6); // Has to be defined before using.
       ...
       if ( status == 1 ) {  // Data TX
           ...
           if (pinfo->dl_dst.type == AT_ETHER) { 
               memcpy(&discovery_phy_dst_addr,pinfo->dl_dst.data,6);// Copy the DST MAC address to local var.
           } 

           if (pinfo->dst.type == AT_IPv4) {        
               memcpy(&discovery_dst_addr,pinfo->dst.data,4); // Copy the DST IPv4 address to local var.     
           } 

           if (  (discovery_phy_dst_addr != 0xffffffffffff) && (discovery_dst_addr != 0xffffffff )  ) 
          {      // Test if DST addresses are the MAC and IPv4 broadcast address

               proto_tree_add_item(hpsdr_u_tree, hf_hpsdr_u_ver, tvb,offset, 1, ENC_BIG_ENDIAN);          
               offset += 1;
	       ...
	       board_id = tvb_get_guint8(tvb, offset);
  		   ...
  		   proto_tree_add_item(hpsdr_u_tree, hf_hpsdr_u_hlite_ver, tvb,offset, 9, ENC_BIG_ENDIAN);
                   ...
                   proto_tree_add_string_format(hpsdr_u_tree, hf_hpsdr_u_host_discover, tvb, offset, 2, placehold,
           ...
           proto_tree_add_item(hpsdr_u_tree, hf_hpsdr_u_com, tvb,offset, 1, ENC_BIG_ENDIAN);
           ...
           if ( flags == 0 ) { 
               ...
               global_flags |=  ( 1 << 0 );   // set                         
               global_flags |=  ( 1 << 1 );   // ? |= ( 1 << n ) -set bit
               global_flags &= ~( 1 << 2 );   // ? &= ~( 1 << n ) -clear bit

           } else if  (flags == 2) { 

               global_flags |=  ( 1 << 0 );  // set            
               global_flags &= ~( 1 << 1 );  // clear 
               global_flags |=  ( 1 << 2 );  // set

           } else if (flags == 3) { 

               //global_flags = 0b00000111;
               global_flags = 0x07;
           ...
           //For displaying global flags, not needed for normal use.
           //proto_tree_add_uint(hpsdr_u_tree,hf_hpsdr_u_com_gf,tvb,offset, 0, global_flags);
       }
